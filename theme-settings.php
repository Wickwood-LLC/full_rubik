 ...
 */
function full_rubik_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['full_rubik'] = array(
    '#type' => 'fieldset',
    '#title' => t('Full Rubik'),
  );
  $form['full_rubik']['rubik_show_branding'] = array(
    '#type' => 'checkbox',
  ...
  $form['full_rubik']['rubik_inline_field_descriptions'] = array(
    '#type' => 'checkbox',
  ...
  $form['full_rubik']['rubik_disable_sticky_sidebar'] = array(
    '#type' => 'checkbox',
  ...
  $form['full_rubik']['rubik_disable_sidebar_in_form'] = array(
    '#type' => 'checkbox',
  ...
  $form['full_rubik']['rubik_sidebar_field_ui'] = array(
    '#type' => 'checkbox',
  ...
  if ($rubik_disable_sidebar_in_form == 1) {
    $form['full_rubik']['rubik_sidebar_field_ui']['#default_value'] = 0;
  }
